          ...
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea
                  ...
                  name="answer"
                  rows="10"
                  class="shadow-sm focus:ring-black focus:border-blue mt-1 block w-full sm:text-sm border-lightgray p-4 border-3 rounded-lg"
                />
              </div>
              <p class="mt-2 text-sm text-gray-500">
                Brief answer to the question, if longer than 10 rows, it should be linked to a blog
            ...
            <div class="grid gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <p class="mt-2 text-sm text-gray-500">Add categories separated by a comma.</p>
              </div>
            </div>
            <div class="grid gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm w-full">
                  ...
                  <ActiveToggle
                    data={faq}
                    on:toggleSave={handleToggle}
                    toggleEnabled={faq.active}
                    enabledColor={"blue"}
